  ...
  return (
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      <Tilt
        ...
        className="bg-tertiary p-s rounded-2x1 sm:w-[360px] w-full"
      >
  ...
  return (
    <>
      <motion.div variants={textVariant()}>
        ...
        <h2 className={styles.heroHeadText}>Project</h2>
      </motion.div>
      ...
      <div className="w-full flex">
        ...
        >
          ...
          link to do code repositories and live demos. it reflext the ability to
          solve the problems, work with different technologies, and manage
          project effectively.
        </motion.p>
      </div>
